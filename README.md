...
| <a name="output_vhub_firewall_private_ip_addresses"></a> [vhub\_firewall\_private\_ip\_addresses](#output\_vhub\_firewall\_private\_ip\_addresses) | Map of private IP addresses of the Firewalls created in each Virtual Hub |
